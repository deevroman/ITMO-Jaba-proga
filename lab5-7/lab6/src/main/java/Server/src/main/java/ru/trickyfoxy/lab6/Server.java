...
import ru.trickyfoxy.lab6.utils.AnswerSender;
import ru.trickyfoxy.lab6.utils.CommandReceiver;
            ...
            while (true) {
                ...
                while (it.hasNext()) {
                    ...
                    if (selectionKey.isReadable()) {
                        ...
                        Command cmd = null;
                        try {
                            cmd = CommandReceiver.getCommand(socketChannel, (Connect) selectionKey.attachment(), timeout);
                        } catch (IOException e) {
                            continue;
